...
;wizardImageFile=imageInstall\install_larger.pbm
;wizardSmallImageFile=imageInstall\paraInstallMenor.pbm
...
[Files]
Source: C:\LabSys\LabSys.exe; DestDir: {app}; Flags: ignoreversion
Source: C:\LabSys\complementos\labsys.sql*; DestDir: {tmp}; Flags : ignoreversion deleteafterinstall
...
;Instalando MySQL 5 em modo silencioso
...
;Inserindo o usuario 
Filename: C:\mysql\bin\mysql.exe; Parameters: "-e ""insert into mysql.user(host,user,password) values ('localhost','root',PASSWORD('root'));"" -u root"; WorkingDir: {tmp}; StatusMsg: Configurando Servidor da Base de Dados Criando Usuario; Flags: runhidden
