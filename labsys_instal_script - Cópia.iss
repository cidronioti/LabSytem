...
Filename: C:\xampp\mysql\bin\mysql.exe; Parameters: "-u root -h localhost -e ""use labsys; source labsys.sql;"; WorkingDir: {tmp}; StatusMsg: Criando Base de Dados; Flags: runhidden
